...
class game:
    def __init__(self, gameid, pbp=True, moments=False):
        ...
        if moments:
            with open("C:\\Users\\kff50\\Documents\\Senior Year\\CMPSC 484\\JSON Practice\\Demo\\Test\\GameFiles\\" + str(gameid) + ".json") as f:
        ...
        if pbp:
            with open("C:\\Users\\kff50\\Documents\\Senior Year\\CMPSC 484\\Basketball Project\\pbp\\2015.12.31.PHO.at.PKC.0021500488.csv") as f:
...
if __name__ == "__main__":
    main(sys.argv[1:])
    g1 = game("0021500472.json", True, True)
    """
    m1 = g1.moments
